  ...
  <div class="config-list">
    ...
    >
      <el-table class="table-header" :data="[{}]" :show-header="false">
        ...
        >
          <template>
            <el-input v-model="columnsDict[f.name]" size="mini" style="width: calc(100% - 15px)" />
    ...
    <el-tabs :active-name="activeTab" @tab-click="onTabClick">
      ...
      <el-tab-pane name="stages" :label="$t('Stages')">
        <!--config detail-->
        <el-row>
          <el-form ref="form" label-width="150px" :model="spiderForm.config" />
        </el-row>
        <!--./config detail-->
          ...
          >
            <template slot="title">
              <ul class="stage-list">
                <!--actions-->
                <li
                  class="stage-item actions"
                  style="min-width: 80px; flex-basis: 80px; justify-content: flex-end"
                  @click="$event.stopPropagation()"
                >
                  <i class="action-item el-icon-copy-document" @click="onCopyStage(stage)" />
                  <i class="action-item el-icon-remove-outline" @click="onRemoveStage(stage)" />
                  <i class="action-item el-icon-circle-plus-outline" @click="onAddStage(stage)" />
                </li>
                <!--./actions-->
                ...
                <li class="stage-item" style="min-width: 240px" @click="$event.stopPropagation()">
                  ...
                  <div v-if="!stage.isEdit" class="text-wrapper" @click="onEditStage(stage)">
                    <span class="text">
                      {{ stage.name }}
                    </span>
                ...
                <li class="stage-item" style="min-width: 240px">
                  ...
                  />
                  <el-popover v-if="isList(stage)" v-model="stage.isListOpen" placement="top" width="360">
                    <el-form label-width="120px">
                      <el-form-item :label="$t('Selector Type')">
                        <el-tag
                          :class="!stage.list_xpath ? 'active' : 'inactive'"
                          type="success"
                          @click="onSelectStageListType(stage, 'css')"
                        >CSS
                        </el-tag>
                        <el-tag
                          :class="stage.list_xpath ? 'active' : 'inactive'"
                          type="primary"
                          @click="onSelectStageListType(stage, 'xpath')"
                        >XPath
                        </el-tag>
                      </el-form-item>
                    ...
                    >
                      <i v-if="!stage.isListOpen" class="el-icon-circle-plus-outline" />
                ...
                <li class="stage-item" style="min-width: 240px">
                  ...
                  />
                  <el-popover v-if="isPage(stage)" v-model="stage.isPageOpen" placement="top" width="360">
                    <el-form label-width="120px">
                      <el-form-item :label="$t('Selector Type')">
                        <el-tag
                          :class="!stage.page_xpath ? 'active' : 'inactive'"
                          type="success"
                          @click="onSelectStagePageType(stage, 'css')"
                        >CSS
                        </el-tag>
                        <el-tag
                          :class="stage.page_xpath ? 'active' : 'inactive'"
                          type="primary"
                          @click="onSelectStagePageType(stage, 'xpath')"
                        >XPath
                        </el-tag>
                      </el-form-item>
                    ...
                    >
                      <i v-if="!stage.isPageOpen" class="el-icon-circle-plus-outline" />
                      <i v-else class="el-icon-remove-outline" />
                      CSS
                    </el-tag>
                    <el-tag
