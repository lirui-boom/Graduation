...
<!--              />-->
<!--            </el-form-item>-->
<!--&lt;!&ndash;            <el-form-item :label="$t('Upload Zip File')" label-width="120px" name="site">&ndash;&gt;-->
<!--&lt;!&ndash;              <el-upload&ndash;&gt;-->
<!--&lt;!&ndash;                :action="$request.baseUrl + '/spiders'"&ndash;&gt;-->
<!--&lt;!&ndash;                :data="uploadForm"&ndash;&gt;-->
<!--&lt;!&ndash;                :headers="{Authorization:token}"&ndash;&gt;-->
<!--&lt;!&ndash;                :on-success="onUploadSuccess"&ndash;&gt;-->
<!--&lt;!&ndash;                :file-list="fileList"&ndash;&gt;-->
<!--&lt;!&ndash;                :before-upload="beforeUpload"&ndash;&gt;-->
<!--&lt;!&ndash;              >&ndash;&gt;-->
<!--&lt;!&ndash;                <el-button id="upload" size="small" type="primary" icon="el-icon-upload">&ndash;&gt;-->
<!--&lt;!&ndash;                  {{ $t('Upload') }}&ndash;&gt;-->
<!--&lt;!&ndash;                </el-button>&ndash;&gt;-->
<!--&lt;!&ndash;              </el-upload>&ndash;&gt;-->
<!--&lt;!&ndash;            </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-row>&ndash;&gt;-->
<!--&lt;!&ndash;              <el-col :span="8">&ndash;&gt;-->
<!--&lt;!&ndash;                <el-form-item :label="$t('Is Scrapy')" prop="is_scrapy">&ndash;&gt;-->
<!--&lt;!&ndash;                  <el-switch&ndash;&gt;-->
<!--&lt;!&ndash;                    v-model="spiderForm.is_scrapy"&ndash;&gt;-->
<!--&lt;!&ndash;                    active-color="#13ce66"&ndash;&gt;-->
<!--&lt;!&ndash;                    @change="onIsScrapy"&ndash;&gt;-->
<!--&lt;!&ndash;                  />&ndash;&gt;-->
<!--&lt;!&ndash;                </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;              </el-col>&ndash;&gt;-->
<!--&lt;!&ndash;              <el-col :span="8">&ndash;&gt;-->
<!--&lt;!&ndash;                <el-form-item :label="$t('Is Git')" prop="is_git">&ndash;&gt;-->
<!--&lt;!&ndash;                  <el-switch&ndash;&gt;-->
<!--&lt;!&ndash;                    v-model="spiderForm.is_git"&ndash;&gt;-->
<!--&lt;!&ndash;                    active-color="#13ce66"&ndash;&gt;-->
<!--&lt;!&ndash;                  />&ndash;&gt;-->
<!--&lt;!&ndash;                </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;              </el-col>&ndash;&gt;-->
<!--&lt;!&ndash;              <el-col :span="8">&ndash;&gt;-->
<!--&lt;!&ndash;                <el-form-item :label="$t('Is Long Task')" prop="is_long_task">&ndash;&gt;-->
<!--&lt;!&ndash;                  <el-switch&ndash;&gt;-->
<!--&lt;!&ndash;                    v-model="spiderForm.is_long_task"&ndash;&gt;-->
<!--&lt;!&ndash;                    active-color="#13ce66"&ndash;&gt;-->
<!--&lt;!&ndash;                  />&ndash;&gt;-->
<!--&lt;!&ndash;                </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;              </el-col>&ndash;&gt;-->
...
<!--&lt;!&ndash;          >&ndash;&gt;-->
<!--&lt;!&ndash;            <p>{{ $t('You can click "Add" to create an empty spider and upload files later.') }}</p>&ndash;&gt;-->
<!--&lt;!&ndash;            <p>{{ $t('OR, you can also click "Upload" and upload a zip file containing your spider project.') }}</p>&ndash;&gt;-->
<!--&lt;!&ndash;            <p>&ndash;&gt;-->
<!--&lt;!&ndash;              <i class="fa fa-exclamation-triangle" /> {{ $t('NOTE: When uploading a zip file, please zip your' +&ndash;&gt;-->
<!--&lt;!&ndash;                ' spider files from the ROOT DIRECTORY.') }}&ndash;&gt;-->
<!--&lt;!&ndash;            </p>&ndash;&gt;-->
<!--&lt;!&ndash;            <p style="font-weight: bolder">&ndash;&gt;-->
<!--&lt;!&ndash;              <template v-if="lang === 'en'">&ndash;&gt;-->
<!--&lt;!&ndash;                Recommend uploading spiders using <a&ndash;&gt;-->
<!--&lt;!&ndash;                  href="https://docs.crawlab.cn/SDK/CLI.html"&ndash;&gt;-->
<!--&lt;!&ndash;                  target="_blank"&ndash;&gt;-->
<!--&lt;!&ndash;                  style="color: #409eff;font-weight: bolder"&ndash;&gt;-->
<!--&lt;!&ndash;                >CLI Tool</a>.&ndash;&gt;-->
<!--&lt;!&ndash;              </template>&ndash;&gt;-->
<!--&lt;!&ndash;              <template v-else-if="lang === 'zh'">&ndash;&gt;-->
<!--&lt;!&ndash;                推荐使用 <a&ndash;&gt;-->
<!--&lt;!&ndash;                  href="https://docs.crawlab.cn/SDK/CLI.html"&ndash;&gt;-->
<!--&lt;!&ndash;                  target="_blank"&ndash;&gt;-->
<!--&lt;!&ndash;                  style="color: #409eff;font-weight: bolder"&ndash;&gt;-->
<!--&lt;!&ndash;                >CLI 工具</a> 上传爬虫。&ndash;&gt;-->
<!--&lt;!&ndash;              </template>&ndash;&gt;-->
<!--&lt;!&ndash;            </p>&ndash;&gt;-->
<!--&lt;!&ndash;          </el-alert>&ndash;&gt;-->
<!--          <div class="actions">-->
...
<!--        </el-tab-pane>-->
        ...
        <el-tab-pane name="configurable" :label="$t('Configurable')">
          <el-form ref="addConfigurableForm" :model="spiderForm" inline-message label-width="120px">
            <el-form-item :label="$t('Spider Name')" prop="name" required>
            ...
            <el-form-item :label="$t('Template')" prop="template" required>
              <el-select
                id="template"
                v-model="spiderForm.template"
                :value="spiderForm.template"
...
<!--          </el-button>-->
      ...
      <!--tabs-->
      <el-tabs v-model="filter.type" class="tabs" @tab-click="onClickTab">
        <el-tab-pane :label="$t('All')" name="all" class="all" />
<!--        <el-tab-pane :label="$t('Customized')" name="customized" class="customized" />-->
        <el-tab-pane :label="$t('Configurable')" name="configurable" class="configurable" />
<!--        <el-tab-pane :label="$t('Long Task')" name="long-task" class="long-task" />-->
      </el-tabs>
      <!--./tabs-->
