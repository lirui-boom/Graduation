...
@Component
public class PredictModelManagerImpl implements PredictModelManager {
    private static String TensorFlow_MODEL_PATH = "/Users/bytedance/Desktop/spider-nlp/src/main/java/cn/boom/spider/nlp/model/lstm_sentiment_model.pb";
//    private static String TensorFlow_MODEL_PATH2 = "/Users/bytedance/Desktop/spider-nlp/src/main/java/cn/boom/spider/nlp/model/lstm_sentiment_model";
    //    private static String WORD_INDEX_PATH = "../data/vocab_words.txt";
    private static String WORD_INDEX_PATH = "/Users/bytedance/Desktop/spider-nlp/src/main/java/cn/boom/spider/nlp/data/vocab_words.txt";
    private static int MAX_SEQUENCE_LENGTH = 100;
    private static int CLASS_NUM = 2;

    @Override
    public float predictNegative(String content) {
        // 构建词典Map
        ...
        try {
            ...
            // 加载TF训练好的模型 方法2
//            Session session = loadTFModel2(TensorFlow_MODEL_PATH, "mytag");
            // 预测结果
            float[][] resultArray = predict_sentence(session, wordsMap, content);
            System.out.print("predictNegative sentence: " + content + ", Predict: " + resultArray[0][0]);
...
//        Session session = loadTFModel(TensorFlow_MODEL_PATH);
        ...
        // 加载TF训练好加载TF训练好的模型的模型 方法2
        Session session = loadTFModel(TensorFlow_MODEL_PATH);

        // 输入预测的标题
//        String test_sentence = "不 好吃 差评";
        String test_sentence = "很 喜欢 颜色 好看";
